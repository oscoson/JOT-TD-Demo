...
start_btn = pygame.image.load(os.path.join("idk", "idk.png")).convert_alpha()
logo = pygame.image.load(os.path.join("idk", "idk.png")).convert_alpha()

class MainMenu:
    def __init__(self, win):
        self.width = 1350
        self.height = 700
        self.bg = pygame.image.load(os.path.join("game_assets", "idk.png"))
