...
star = pygame.transform.scale(pygame.image.load("star-2.jpg").convert_alpha(), (50,50))
star2 = pygame.transform.scale(pygame.image.load("Star-PNG-HD.png").convert_alpha(), (20,20))
